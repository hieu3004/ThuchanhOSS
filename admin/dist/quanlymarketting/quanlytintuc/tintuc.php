                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="quanlytintuc.php" >
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Quản lý Bài viết
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
            ...
            <main>
                    <div class="container-fluid">
                        ...
                        <div  class="card mb-4"style="width:500px;">
                            ...
                            <div class="card-body" >
                                <form action="chucnang.php?action=them" enctype="multipart/form-data" method="post" width="550px">
                                    <div style="width:0px; float:left;height:200px">
                                        <table > 
                                            ...
                                            <tr>
                                                <td>Nội dung:</td>
                                                <td><textarea name="noidung" id="" cols="20" rows="3"></textarea></td>
                                            </tr>
