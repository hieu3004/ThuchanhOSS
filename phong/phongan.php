...
<body>
    ...
    <?php 
         ...
         $sql="SELECT * FROM  sanpham WHERE sanpham.makhonggian='PA' ";
         $stm=$obj->prepare($sql);
         $stm->execute();
            ...
            <div class="carousel slide" id="myCarousel">
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <ul class="thumbnails">
                                <?php
                                    $sqla="SELECT * from sanpham  where sanpham.makhonggian='PK' or sanpham.makhonggian='PN' or sanpham.makhonggian='PLV' order by RAND() LIMIT 4";
